...
<head>
    ...
    <title>BlcokCity区块市场 - BlockCity区块城市区块交易平台 | BlockCity </title>
    <meta name="description" content="BlockCity区块城市区块交易平台。">
    <meta name="keywords" content="58,区块,区块城市,BlockCity,DAO,同城交流,Avatar">
    ...
    <header>
        <div class="header-container">
            ...
            <div class="header-actions">
                ...
                <!-- 新增的导航按钮 -->
                <a href="../sale_list.php" class="nav-button">
                    <i class="fas fa-tag"></i> 售卖
                </a>
                <a href="../purchase_list.php" class="nav-button">
                    <i class="fas fa-hand-holding-usd"></i> 求购
                </a>
                <a href="../claim_list.php" class="nav-button">

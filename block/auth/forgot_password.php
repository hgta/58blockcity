...
.card { background:white; border-radius:8px; padding:30px; box-shadow:0 2px 15px rgba(0,0,0,0.1); text-align:center; }
...
.btn { width:100%; padding:12px; background:#ff6b00; color:white; border:none; border-radius:6px; font-size:16px; cursor:pointer; }
</style>
<div class="container">
    <div class="card">
        ...
        <div style="margin-top:15px">
            <a href="login.php" style="color:#3498db;font-size:13px;">返回登录</a>
        </div>
    </div>
</div>

...
<div style="display:grid;grid-template-columns:340px 1fr;gap:20px;align-items:start;">
    ...
    <div class="admin-card">
        <div class="admin-card-body" style="text-center;">
            <img src="<?= htmlspecialchars(User::avatarUrl($userInfo['avatar'] ?? '')) ?>" alt="" style="width:120px;height:120px;border-radius:50%;object-fit:cover;margin-bottom:16px;" onerror="this.onerror=null;this.src='https://www.58.tl/assets/images/default.jpg'">

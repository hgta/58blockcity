    ...
    <div class="admin-card-body" style="display:grid;grid-template-columns:1fr 1fr;gap:0 30px;">
        <div>
            ...
            <div class="admin-info-item">
                ...
                <span style="display:flex;align-items:center;gap:8px;">
                    <img src="<?= htmlspecialchars(User::avatarUrl($ownerInfo['avatar'] ?? '')) ?>" alt="" style="width:24px;height:24px;border-radius:50%;object-fit:cover;" onerror="this.onerror=null;this.src='https://www.58.tl/assets/images/default.jpg'">
        ...
        <div>
            <div class="admin-info-item">
                <label>访问者</label>
                <span style="display:flex;align-items:center;gap:8px;">
                    <img src="<?= htmlspecialchars(User::avatarUrl($visitorInfo['avatar'] ?? '')) ?>" alt="" style="width:24px;height:24px;border-radius:50%;object-fit:cover;" onerror="this.onerror=null;this.src='https://www.58.tl/assets/images/default.jpg'">

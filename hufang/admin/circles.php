                ...
                <?php else: ?>
                    <?php foreach ($circles as $c): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display:flex;align-items:center;gap:8px;">
                                    <img src="<?= htmlspecialchars(User::avatarUrl($creator['avatar'] ?? '')) ?>" alt="" style="width:28px;height:28px;border-radius:50%;object-fit:cover;flex-shrink:0;" onerror="this.onerror=null;this.src='https://www.58.tl/assets/images/default.jpg'">
